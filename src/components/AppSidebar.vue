...
const sidebarTheme = computed(() => {
  if (appearanceStore.theme === "dark") return "dark";
  if (appearanceStore.theme === "light") return "light";
...
const navGroups = computed(() => [
  {
    label: uiText.value.groups.main,
    items: [
      {
        key: "dashboard",
        label: uiText.value.items.dashboard,
        path: "/dashboard",
      ...
      {
        key: "attendance",
        label: uiText.value.items.attendance,
        path: "/absensi",
        badge: uiText.value.items.today,
        icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>`,
      },
      {
        key: "history",
        label: uiText.value.items.history,
        path: "/riwayat",
  ...
  {
    label: uiText.value.groups.info,
    items: [
      {
        key: "schedule",
        label: uiText.value.items.schedule,
        path: "/jadwal",
  ...
  {
    label: uiText.value.groups.account,
    items: [
      {
        key: "profile",
        label: uiText.value.items.profile,
        path: "/profil",
        icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/>`,
      },
      {
        key: "settings",
        label: uiText.value.items.settings,
        path: "/pengaturan",
...
<template>
  ...
  <aside class="sb-root" :class="{ 'sb-open': open }" :data-theme="sidebarTheme">
    <div class="sb-brand">
      <div class="sb-logo">
      ...
      <button class="sb-close" @click="emit('close')" :aria-label="uiText.closeSidebar">
...
.sb-root[data-theme="dark"] {
  ...
  --sb-green-light: rgba(34, 197, 94, 0.12);
  --sb-green-mid: rgba(34, 197, 94, 0.24);
  --sb-text: #bbf7d0;
  --sb-muted: #94a3b8;
}
...
.sb-root[data-theme="dark"] .sb-group-label {
  color: #64748b;
}
...
.sb-root[data-theme="dark"] .sb-item {
  color: #cbd5e1;
}
.sb-item:hover {
...
.sb-root[data-theme="dark"] .sb-item-icon {
  background: #1f2937;
}
.sb-item-icon svg {
  width: 15px;
...
.sb-root[data-theme="dark"] .sb-logout {
...
.sb-root[data-theme="dark"] .sb-logout:hover {
...
.sb-root[data-theme="dark"] .sb-version {
  color: #64748b;
}
